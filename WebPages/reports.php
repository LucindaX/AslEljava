	...
	<div class="shell">
		...
		<div id="main">
			...
			<div class="products">
				...
				<div class="product-holder">
					<div class="product">
                                            <a title="Details" href="searchByVisits.php"><img src="resources/css/images/visits.png" alt="Beautiful white case with flower motives" style="margin-bottom: 40px; margin-top: 15px;"/></a>			
